...
const LiveScanning = ({ selectedEvent }) => {
    ...
    const fetchAll = useCallback(async () => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                setError(res.status === 403 ? "You are not authorized for this event." : body.error || "Failed to load data.");
                setRows([]); return;
            }
            ...
            console.error("LiveScanning fetch error:", err);
        ...
        <div className="scan-container">
            <div className="scan-header">
                <div className="sc-header-left">
                    <h1 className="sc-title">Live Scanning</h1>
                    <p className="small-body-text sc-header-subtitle">Real-time attendance monitoring and manual entry</p>
                </div>
            </div>
                    ...
                    <div className="sc-content-columns">
                        <div className="sc-left-col">
                            ...
                            <div className="sc-card sc-scan-box">
                                ...
                                <h4>Ready to Scan</h4>
                                <p className="small-body-text sc-scan-text">Scan ticket QR codes or use manual search to record entries.</p>
                            ...
                            <div className="sc-card sc-recent-box">
                                ...
                                <div className="sc-recent-list">
                                    {recentCheckins.length === 0 ? (
                                        <p className="small-body-text" style={{ textAlign: 'center', color: 'var(--color-black-tertiary)' }}>No scanning activity yet.</p>
                                    ) : (
            ...
            <QRScannerModal
                ...
                title="Admin Scanning: Attendee / Booth"
            />
        </div>
    );
};
