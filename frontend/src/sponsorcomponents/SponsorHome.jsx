            ...
            <footer className="sponsor-footer">
                <div className="sponsor-footer-grid">
                    <div className="sponsor-footer-logo-col">
                        ...
                        <p className="small-body-text footer-desc">The easiest way to discover and book tickets for your favorite events. Secure, fast, and reliable.</p>
                    </div>
                    <div className="sponsor-footer-col">
                        <h4>Discover</h4>
                        <a href="#concerts" className="small-body-text">Concerts</a>
                        <a href="#sports" className="small-body-text">Sports</a>
                        <a href="#theater" className="small-body-text">Theater</a>
                        <a href="#festival" className="small-body-text">Festival</a>
                    </div>
                    <div className="sponsor-footer-col">
                        <h4>Support</h4>
                        <a href="#help" className="small-body-text">Help Center</a>
                        <a href="#contact" className="small-body-text">Contact Us</a>
                        <a href="#refund" className="small-body-text">Refund Policy</a>
                        <a href="#privacy" className="small-body-text">Privacy Policy</a>
                    </div>
                    <div className="sponsor-footer-col">
