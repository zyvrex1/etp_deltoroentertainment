...
const CustomerAddPaymentMethod = ({ isOpen, onClose, onMethodAdded }) => {
        ...
        <div className="capm-modal-overlay">
            <div className="capm-modal-container">
                    ...
                    {selectedMethod === 'credit_card' && (
                        <>
                            <div className="capm-input-group">
                                ...
                                <input type="text" className="capm-input regular-body-text" placeholder="Enter name here" value={cardHolder} onChange={(e) => setCardHolder(e.target.value)} />
                            </div>
                            <div className="capm-input-group">
                            ...
                            <div className="capm-row">
                                <div className="capm-input-group flex-1">
                                    ...
                                    <input type="text" className="capm-input regular-body-text" placeholder="MM/YY" maxLength="5" value={expires} onChange={(e) => {
                                ...
                                <div className="capm-input-group flex-1">
                                    ...
                                    <div className="capm-input-icon-wrapper">
                                        <input type="password" maxLength="4" className="capm-input regular-body-text pr-icon" placeholder="•••" value={cvv} onChange={(e) => setCvv(e.target.value.replace(/\D/g, ""))} />
                    ...
                    {selectedMethod === 'upi' && (
                        <>
                            <div className="capm-input-group">
                                ...
                                <input type="text" className="capm-input regular-body-text" placeholder="username@bank" value={upiId} onChange={(e) => setUpiId(e.target.value)} />
                            </div>
                        </>
                    )}
                    ...
                    {selectedMethod === 'paypal' && (
                        <>
                            <div className="capm-input-group">
                                ...
                                <input type="email" className="capm-input regular-body-text" placeholder="Enter PayPal email address" value={paypalEmail} onChange={(e) => setPaypalEmail(e.target.value)} />
                            </div>
                        </>
                    )}

                    <label className="capm-checkbox-container mt-12">
                        <input type="checkbox" className="capm-checkbox" checked={isDefault} onChange={(e) => setIsDefault(e.target.checked)} />
                ...
                <div className="capm-form-actions">
                    ...
                    <button className="capm-submit-btn regular-body-text font-medium" onClick={handleAddMethod} disabled={isSubmitting}>
