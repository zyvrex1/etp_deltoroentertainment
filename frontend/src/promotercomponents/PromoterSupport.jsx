...
import PromoterDocuments from './PromoterModal/PromoterDocuments';
import PromoterViewConcern from './PromoterViewConcern';
...
export default function PromoterSupport() {
    ...
    const faqs = [
        {
            question: "How do I create and manage an event?",
            answer: "Click 'Create Event' from your promoter dashboard. Fill in event details, set the date and venue, upload ticket structures/layout maps, and submit for admin approval. Once approved, the event goes live."
        },
        {
            question: "When and how are payouts processed?",
            answer: "Payouts are initiated after successful completion of events. Setup your preferred payout billing details under Payout Billing. Admin checks ticket sales reports before releasing funds."
        },
        {
            question: "How can I check sales and revenue analytics?",
            answer: "Go to the Revenue section in the sidebar. You can view charts, net sales, breakdown by ticket categories, and download CSV/PDF summary reports."
        },
        {
            question: "Can I edit an event after it has been approved?",
            answer: "Minor edits like details and descriptions can be changed. However, changing prices, layout structures, or event dates will require re-approval from administrators."
        },
        {
            question: "What support is provided for scanning tickets at the door?",
            answer: "We offer a built-in mobile scanner tool under the 'Scan Tickets' tab. You can use your mobile camera to instantly scan and validate QR codes of attendees."
        }
    ];
            ...
            <div className="submit-concern-card">
                ...
                <form className="concern-form" onSubmit={async (e) => {
                    ...
                    <div className="form-group">
                        ...
                        <input 
                            type="text" 
                            placeholder="e.g. Grand Event Launch" 
                    ...
                    <div className="form-row">
                        <div className="form-group col">
                            ...
                            >
                                ...
                                <option>Event Approval Assistance</option>
                                <option>Ticket Structure Issue</option>
    ...
    return (
        <div className="promoter-support-page">
            <div className="support-header">
                <h2>Support Center</h2>
                <p className="regular-body-text">How can we help you today? Search our help center or submit a ticket to administrators.</p>
            </div>
