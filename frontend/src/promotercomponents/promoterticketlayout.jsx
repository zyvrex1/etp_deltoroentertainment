...
const PromoterTicketLayout = ({ selectedEvent }) => {
  ...
  useEffect(() => {
    if (!selectedCategoryId && priceLevels.length > 0) {
      // If only one category, auto-select it. If multiple, don't auto-select (let user choose)
...
export default PromoterTicketLayout;
