...
const PromoterAttendees = () => {
  ...
  const filteredData = attendeesData.filter((row) => {
    ...
    return (
      ...
      row.pill.toLowerCase().includes(q)
    );
  });
  ...
  const exportList = async () => {
    ...
    try {
      ...
      pdf.setFont("helvetica", "normal");
      pdf.text(
        "Attendee list export. Use the dashboard for real-time check-in status.",
        margin,
        y,
                  ...
                  {paginatedData.map((row, index) => (
                    ...
                    >
                      ...
                      <td className="type-cell" data-label="Ticket Type">
                        <span className={`button-label type-${row.type}`}>
                          {row.pill}
                        </span>
                      </td>
                      <td
                      ...
                      <td
                        ...
                        className="small-body-text att-time-col"
                      >
